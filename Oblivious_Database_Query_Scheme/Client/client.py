...
from Oblivious_Database_Query_Scheme.Client.Utilities.file_decryptor import run as decrypt_and_store_files
...
class Communicator(Utilities):
    ...
    def send_online_message_and_resume_boolean(self):
        """
