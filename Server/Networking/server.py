...
class Communicate:
    ...
    def __init__(self):
        ...
        self.server_context.load_cert_chain(certfile='Server/Networking/Keys/cert.pem', keyfile='Server/Networking/Keys/key.pem', password='password')   # Ohh no leaking the password
