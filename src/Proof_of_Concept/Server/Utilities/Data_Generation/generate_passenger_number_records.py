...
from Proof_of_Concept.getters import (get_records_directory as
                                      records_directory)
from Proof_of_Concept.getters import (get_supplementary_data_directory as
...
class GenerateTravelInformation:
    ...
    def __init__(self) -> None:
        ...
        self.travel_agencies = [('None', 0.5), ('Balslev', 0.0625), ('TUI', 0.0625), ('Norsktur', 0.0625),
                                ('Solfaktor', 0.0625), ('Ving', 0.0625), ('Charter', 0.0625), ('Apollo', 0.0625),
                                ('Expedia', 0.0625)]
